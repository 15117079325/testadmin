...
*/
	...
	if (!isset($_GET['code']))
	{
		...
		// 触发微信返回code码
		$url_str = 'https://www.lezhunet.com/weixinpay/demo/js_api_call.php?order_no='.$_GET['order_no'].'&money='.$_GET['money'];
...
<head>
	...
	<script src="<?='/static/assets/scripts/form-validation.js'?>"></script>
...
//						    	    if(ret.status == 'success'){
                                        //支付成功
                                        alert('支付成功');
                                        window.location.href="/web/bank/refill";
