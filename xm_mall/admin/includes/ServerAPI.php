...
class ServerAPI{
    ...
    public function __construct(){
        //test
//          $this->appKey = 'qf3d5gbjqhafh';
//          $this->appSecret = 'PWP5oDZmdQS';
        //product
      $this->appKey = 'sfci50a7s8rfi';
       $this->appSecret = 'He3FDU8Sadxe';
 ...
 */
    ...
    public function groupUserBanWhitelistRollback($userId,$groupId) {
        try{
            ...
            $params['userId'] = $userId;
            $params['groupId'] = $groupId;
            $ret = $this->curl('/group/user/ban/whitelist/rollback
