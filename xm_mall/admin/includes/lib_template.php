...
/*        '/library/ur_here.lbi' => 0,
    ...
    'barter_big_list' => array(
        '/library/ur_here.lbi' => 0,
        '/library/cart.lbi' => 0,
        '/library/category_tree.lbi' => 0,
        '/library/history.lbi' => 0,
        '/library/pages.lbi' => 0,
        '/library/barter_big_hot.lbi' => 5,
        '/library/barter_big_list.lbi' => 0,
    ),
    'barter_mid_list' => array(
        '/library/ur_here.lbi' => 0,
        '/library/cart.lbi' => 0,
        '/library/category_tree.lbi' => 0,
        '/library/history.lbi' => 0,
        '/library/pages.lbi' => 0,
        '/library/barter_mid_hot.lbi' => 5,
        '/library/barter_mid_list.lbi' => 0,
    )
);
