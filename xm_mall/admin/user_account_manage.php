...
if ($_REQUEST['act'] == 'list')
{
    ...
    $account['user_money']     = price_format($money_list['user_money']);   //用户可用优惠券
    ...
    $account['surplus']        = price_format($money_list['surplus']);   //交易使用优惠券
    $account['integral_money'] = price_format($money_list['integral_money']);   //积分使用优惠券
