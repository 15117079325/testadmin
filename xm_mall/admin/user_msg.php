...
if ($_REQUEST['act']=='insert')
{
    $sql = "INSERT INTO " . $ecs->table('feedback') . "(parent_id, user_id, user_name, user_email, msg_title, msg_type, msg_content, msg_time, message_img, order_id)" .
            ...
            " '$_POST[msg_title]', 5, '$_POST[msg_content]', '" . time() . "', '', '$_POST[order_id]')";
...
elseif ($_REQUEST['act']=='action')
{
    if (empty($_REQUEST['parent_id']))
    {
        $sql = "INSERT INTO ".$ecs->table('feedback')." (msg_title, msg_time, user_id, user_name , ".
                ...
                "VALUES ('reply', '".time()."', '".$_SESSION['admin_id']."', ".
    ...
    {
        $sql = "UPDATE ".$ecs->table('feedback')." SET user_email = '".$_POST['user_email']."', msg_content='".$_POST['msg_content']."', msg_time = '".time()."' WHERE msg_id = '".$_REQUEST['parent_id']."'";
        $db->query($sql);
    }
