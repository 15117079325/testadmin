...
define('VT_MOBILE_CASH_TRANSFER', 'mobile_cash_transfer');// 新美积分转账验证
define('VT_MOBILE_CONSUME_TRANSFER', 'mobile_cosume_transfer');// 消费积分转账验证
define('VT_MOBILE_LOGIN_ADMIN', 'mobile_login_admin');// 后台登录 手机验证码验证
define('VT_MOBILE_LOGIN_UCENTER', 'mobile_login_ucenter');// 后台 手机验证码验证

//商品类型
define('BARTER_TYPE_BIG',1); //易业商城
define('BARTER_TYPE_MID',2); //精品商城
define('BARTER_TYPE_SMALL',3); //小易物

//快钱支付状态
define('RECHARGE_STATUS_WAIT_PAY',0); //待支付
define('RECHARGE_STATUS_PAIED',1); //已支付
