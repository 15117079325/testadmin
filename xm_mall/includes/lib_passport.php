 ...
 * @return bool $bool
 */
function register_by_username ($username, $password, $email, $mobile, $invite_code, $other = array())
{
	return _register_mq($username, $password, $email, $mobile, $invite_code,$other, 'username');
}
 ...
 * @return bool $bool
 */
function register_by_mobile ($username, $password, $mobile, $invite_code,$other = array())
{
	return _register_mq($username, $password, '',$mobile, $invite_code,$other,'mobile');
}
 ...
 * @return boolean
 */
function _register_mq ($username, $password, $email,$mobile,$invite_code,$other = array())
{
	/* 检查注册是否关闭 */
	...
	$result = $GLOBALS['user']->mq_add_user($username, $password,$email,$mobile,$invite_code);
...
//		$result = $GLOBALS['user']->add_user($username, $password, $email);
		...
		$result = $GLOBALS['user']->mq_add_user($username, $password, $email,$mobile_phone,$invite_code);
	}
	else
	{
