...
$_LANG['js_languages']['cash_not_int'] = '新美积分不是整数';
$_LANG['js_languages']['consume_not_int'] = '消费积分不是整数';
$_LANG['js_languages']['invest_not_int'] = '待用积分不是整数';
$_LANG['js_languages']['share_not_int'] = '分享积分不是整数';
$_LANG['js_languages']['shopping_not_int'] = '购物券不是整数';
$_LANG['js_languages']['register_not_int'] = '注册积分不是整数';
$_LANG['js_languages']['useable_not_int'] = '可用积分不是整数';
