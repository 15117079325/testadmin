...
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2013-2017 杭州码趣科技有限公司，并保留所有权利。';
...
$_LANG['06_admin'] = '权限管理';
$_LANG['07_system'] = '系统设置';
$_LANG['08_invest'] = '积分管理';
$_LANG['09_recharge_review'] = '审核管理';
$_LANG['10_announce'] = '交易大厅管理';
$_LANG['11_suggestions'] = '意见反馈';
$_LANG['12_management'] = '运营管理';
$_LANG['13_mid_autumn'] = '国庆活动';
$_LANG['14_getui'] = '消息推送';
$_LANG['15_community'] = '火单头条';
$_LANG['16_examine'] = '钱包管理';
...
$_LANG['big_order_query'] = '易业商城订单查询';
$_LANG['mid_order_query'] = '精品商城订单查询';
$_LANG['h_order_query'] = 'H单订单查询';
...
$_LANG['recharge_log_lists'] = '快钱充值记录';


$_LANG['buyback_list'] = 'H单';
//end

$_LANG['02_h_dan_list'] = 'H单商品管理';
$_LANG['01_small_yiwu_list'] = '小易物商品管理';

$_LANG['xinmei_settings'] = '参数配置';
$_LANG['recommend_commission_lists'] = '商品推荐提成统计';

$_LANG['mq_dash_board'] = '起始页';

$_LANG['my_team_count'] = '团队业绩';
$_LANG['wechat_business_audit_lists'] = '服务中心审核';


//首页
$_LANG['01_carousel_list'] = '轮播管理';
$_LANG['02_navigation_list'] = '热搜词管理';
$_LANG['03_rec_list'] = '商品推荐管理';
$_LANG['04_hot_list'] = '导航栏管理';

//商品
$_LANG['01_attr_list'] = '商品管理';
$_LANG['02_goods_list'] = '属性值管理';
$_LANG['03_attr_val_list'] = '属性管理';
$_LANG['04_cate_list'] = '分类管理';
$_LANG['05_goods_list'] = '秒杀管理';

// 订单
$_LANG['01_order_list'] = 'APP订单管理';
$_LANG['02_buyback_list'] = 'H单订单';
$_LANG['03_order_comment'] = '订单评论';

//报表统计
$_LANG['01_deal_list'] = '交易大厅数据统计';
$_LANG['02_dealing_list'] = '求购排队数据统计';
$_LANG['03_performance_list'] = '服务中心数据统计';
$_LANG['04_trade_list'] = '业绩统计';
$_LANG['04_fruit_data'] = '水果机数据';
$_LANG['05_chart_group'] = '数据统计'; // 20180521 1537 V
$_LANG['06_push_list'] = '直推排行榜';
$_LANG['07_h_buyback_stats'] = 'H单统计';
$_LANG['08_integral_ranking_list'] = '积分排行榜';
$_LANG['09_mq_account_transfer_stats'] = '积分转账统计';
$_LANG['10_mq_pre_recharge_count']='报单统计';
$_LANG['15_top_account'] = '用户优惠券排行';
$_LANG['11_register_user'] = '注册会员数据';
$_LANG['12_release_balance'] = '释放优惠券数据';
$_LANG['13_balance_data'] = '优惠券数据统计';
$_LANG['14_app_team_order'] = '团队报单统计';

//$_LANG['recharge_audit_count'] = '充值排行统计';
//$_LANG['cash_count_list'] = '提现排行统计';
//$_LANG['recharge_audit_count_new']='新充值排行统计';
//$_LANG['cash_count_list_new']='新提现排行统计';


//会员
$_LANG['01_users_list'] = '会员列表';
//$_LANG['02_restriction_list'] = '限制会员列表';
//$_LANG['03_user_translation'] = '会员平移';
//$_LANG['04_user_translation_log'] = '会员平移日志';

//权限管理
$_LANG['01_admin_logs'] = '管理员日志';
$_LANG['02_admin_list'] = '管理员列表';
$_LANG['03_admin_role'] = '角色列表';


//系统设置
$_LANG['01_config_settings'] = '参数配置'; // 20180508 1326 V
$_LANG['02_mq_hdan_pause'] = 'H单暂停';
$_LANG['03_fruit_settings'] = '水果机配置';
$_LANG['04_add_announce'] = "说明设置";

//积分管理
$_LANG['01_integration_details'] = '积分流水查询';

//审核
//$_LANG['02_cash_audit_lists'] = '提现审核';
//$_LANG['01_recharge_audit_lists'] = '充值审核列表';
$_LANG['03_name_cert_lists'] = "实名认证审核";
//$_LANG['04_transfer_audit_lists']='转账审核';


//交易大厅
//$_LANG['23_announce']="交易大厅管理";
//$_LANG['02_list_announce']="交易大厅列表";
//$_LANG['03_trade_settings'] = '交易大厅开关'; // 20180508 1326 V
//$_LANG['04_trade_parameter'] = '交易大厅参数'; // 20180508 1326 V

// 意见反馈
$_LANG['24_mq_suggestions'] = '意见反馈';
$_LANG['01_suggestions_manage'] = '意见列表';

//运营管理
//$_LANG['01_group_list']='群组管理';
$_LANG['02_service_list'] = '客服管理';
//$_LANG['03_message_list']='系统消息管理';
$_LANG['04_share_img'] = '分享图片';
$_LANG['05_alert_img'] = '首页弹窗';

//国庆活动
$_LANG['01_prize_setting'] = '奖品设置';
$_LANG['02_winning_record'] = '获奖记录';

//消息推送
$_LANG['01_getui_send'] = '发布消息';
$_LANG['02_getui_audit'] = '消息审核';

//火单头条
$_LANG['01_community_content'] = '火单头条内容';

//测试
$_LANG['16_examine_option'] = '银行卡列表';
$_LANG['16_examine_list'] = '审核列表';
$_LANG['16_pass_list'] = '审核结果';