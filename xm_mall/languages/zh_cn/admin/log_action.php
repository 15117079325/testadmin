...
//add  by  fuhuaquan  2018/1/8
$_LANG['log_action']['check'] = '审核';
$_LANG['log_action']['mannage'] = '管理';
$_LANG['log_action']['member'] = '会员';
...
$_LANG['log_action']['goods_trash'] = '商品回收站的商品';
...
//add by fuahuquan  2018/1/8
$_LANG['log_action']['audit'] = '管理';
$_LANG['log_action']['recharge'] = '充值';
$_LANG['log_action']['big_goods'] = '易业商城商品';
$_LANG['log_action']['mid_goods'] = '精品商城商品';
...
$_LANG['log_action']['xinmei_config'] = '系統設置:参数配置';
$_LANG['log_action']['xinmei_form_config'] = '新美配置:报单配置';
$_LANG['log_action']['xinmei_bank_config'] = '新美配置:銀行信息';


$_LANG['log_action']['xinmei_edit'] = '修改';
$_LANG['log_action']['languages'] = '前台语言项';
$_LANG['log_action']['user_surplus'] = '会员优惠券';
$_LANG['log_action']['message'] = '会员留言';
$_LANG['log_action']['fckfile'] = 'FCK文件';
$_LANG['log_action']['announce'] = '公告';
