...
$_LANG['users_edit'] = '审核会员实名认证';
$_LANG['goto_list'] = '返回实名认证列表';
...
$_LANG['notice_cash_credit'] = '新美积分介绍。。。';
$_LANG['notice_invest_credit'] = '待用积分介绍。。。';
$_LANG['notice_consume_credit'] = '消费积分介绍。。。';
...
$_LANG['update_success'] = '用户认证信息已经修改成功。';
$_LANG['still_accounts'] = '该会员有优惠券或欠款\n';
$_LANG['remove_confirm'] = '您确定要删除该会员账号吗？';
$_LANG['forbiden_confirm'] = '您确定要禁用该会员账号吗？';
$_LANG['recover_confirm'] = '您确定要启用该会员账号吗？';
$_LANG['list_still_accounts'] = '选中的会员账户中仍有优惠券或欠款\n';
...
$_LANG['forbiden_success'] = '会员账号 %s 已经禁用成功。';
$_LANG['recover_success'] = '会员账号 %s 已经启用成功。';
