...
$_LANG['cfg_name']['use_surplus'] = '是否使用优惠券';
...
//add shengl 2017年2月8日16:40:15
$_LANG['integral_settings'] = '积分配置设置';
$_LANG['integral_settings_note'] = '积分配置设置各种积分之间的转换比例，不会对之前的是数据造成影响';
/* 积分设置语言项 */
$_LANG['cfg_name']['xm_precharge'] = '报单配置';
$_LANG['cfg_name']['xm_bank_info_setting'] = '银行信息';
$_LANG['cfg_name']['xm_exchange'] = '积分兑换';
$_LANG['cfg_name']['xm_credit_invest'] = '积分倍增';
$_LANG['cfg_name']['xm_transfer'] = '积分转账';
$_LANG['cfg_name']['xm_take_cash'] = '提现管理';

$_LANG['cfg_name']['xm_precharge_amount_min'] = '报单金额下限：';
$_LANG['cfg_desc']['xm_precharge_amount_min'] = '报单一次最低金额额度';
$_LANG['cfg_name']['xm_precharge_amount_max'] = '报单金额上限：';
$_LANG['cfg_desc']['xm_precharge_amount_max'] = '报单一次最高金额额度';
$_LANG['cfg_name']['xm_precharge_rate_c_s_r'] = '报单积分投入比：';
$_LANG['cfg_desc']['xm_precharge_rate_c_s_r'] = '报单投入的新美积分、消费积分、注册积分之间的比例（例：4:4:2）';
$_LANG['cfg_name']['xm_precharge_rate_all_shop'] = '购物券产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_shop'] = '报单成功后报单额度与发放的购物券比例（例：1:1）';
$_LANG['cfg_name']['xm_precharge_rate_all_consume'] = '消费积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_consume'] = '报单成功后报单额度与赠送的消费积分比例（例：1:0.2）';
$_LANG['cfg_name']['xm_precharge_rate_all_invest'] = '待用积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_invest'] = '报单成功后报单额度与赠送的待用积分比例（例：1:3）';
$_LANG['cfg_name']['xm_precharge_rate_all_usable'] = '可用积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_usable'] = '报单成功后报单额度与赠送的可用积分比例（例：1:1）';
$_LANG['cfg_name']['xm_precharge_rate_all_share'] = '分享积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_share'] = '报单成功后报单额度与赠送的分享积分比例（例：1:2）';
$_LANG['cfg_name']['xm_precharge_rate_all_cash'] = '新美积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_cash'] = '报单成功后报单额度与新美积分比例（例：1:1）';
$_LANG['cfg_name']['xm_precharge_rate_all_register'] = '注册积分产出比：';
$_LANG['cfg_desc']['xm_precharge_rate_all_register'] = '报单成功后报单额度与赠送的注册积分比例（例：1:1）';
$_LANG['cfg_name']['xm_precharge_bonus_recommend'] = '直推奖励(%)：';
$_LANG['cfg_desc']['xm_precharge_bonus_recommend'] = '直推所能获得的回报百分比（例：5）';
$_LANG['cfg_name']['xm_precharge_bonus_loop_count'] = '向上追溯层级：';
$_LANG['cfg_desc']['xm_precharge_bonus_loop_count'] = '分享积分不够时向上追溯推荐人层级（例：5）';
$_LANG['cfg_name']['xm_precharge_bonus_my_top'] = '二代奖励(%)：';
$_LANG['cfg_desc']['xm_precharge_bonus_my_top'] = '二代所能获得的奖励的百分比（例：5）';
$_LANG['cfg_name']['xm_precharge_amount_monthly_ma'] = '自我报单月上限：';
$_LANG['cfg_desc']['xm_precharge_amount_monthly_ma'] = '每月允许自我报单的金额';
//$_LANG['cfg_name']['xm_precharge_bonus_my_top_top'] = '上上级奖励(%)：';
//$_LANG['cfg_desc']['xm_precharge_bonus_my_top_top'] = '上上级所能获得的奖励的百分比（例：10）';
$_LANG['cfg_name']['xm_bank_info_account'] = '账号：';
$_LANG['cfg_desc']['xm_bank_info_account'] = '银行账户号码（例子：完整的账户号码）';
$_LANG['cfg_name']['xm_bank_info_account_name'] = '账户名：';
$_LANG['cfg_desc']['xm_bank_info_account_name'] = '银行账户开户的真实名称';
$_LANG['cfg_name']['xm_bank_info_account_branch'] = '开户银行：';
$_LANG['cfg_name']['xm_bank_info_qrcode_wx'] = '微信二维码：';
$_LANG['cfg_name']['xm_bank_info_qrcode_zfb'] = '支付宝二维码：';
$_LANG['cfg_desc']['xm_bank_info_account_branch'] = '银行账户开户行名称（例：中国银行西湖支行）';
$_LANG['cfg_name']['xm_exchange_cash_shopping'] = '现金兑购物券：';
$_LANG['cfg_desc']['xm_exchange_cash_shopping'] = '现金兑换购物券比例（例：1:1）';
$_LANG['cfg_name']['xm_exchange_cash_consume'] = '现金兑消费：';
$_LANG['cfg_desc']['xm_exchange_cash_consume'] = '现金兑换消费积分比例（例：1:3）';
$_LANG['cfg_name']['xm_exchange_cash_share'] = '现金兑分享：';
$_LANG['cfg_desc']['xm_exchange_cash_share'] = '现金兑换分享积分比例（例：1:2）';
$_LANG['cfg_name']['xm_exchange_cash_register'] = '现金兑注册：';
$_LANG['cfg_desc']['xm_exchange_cash_register'] = '现金兑换注册积分比例（例：1:1）';
$_LANG['cfg_name']['xm_credit_invest_reinvest_per'] = '允许复投比例(1/N)：';
$_LANG['cfg_name']['xm_credit_invest_beishu_mult'] = '复投倍增比例';
$_LANG['cfg_desc']['xm_credit_invest_reinvest_per'] = '格式：1/2:1/1 可复投2次，第1次只能投1/2，第2次 1/1';
$_LANG['cfg_desc']['xm_credit_invest_beishu_mult'] = '格式：2:3说明 可复投2次，第一次2倍，第二次3倍';

$_LANG['cfg_name']['xm_transfer_rate_consume_fee'] = '消费积分转账消耗(%)';
$_LANG['cfg_desc']['xm_transfer_rate_consume_fee'] = '上下级间免费，隔代或旁系才扣除手续费';
$_LANG['cfg_name']['xm_transfer_rate_cash_fee'] = '新美积分转账手续费(%)';
$_LANG['cfg_desc']['xm_transfer_rate_cash_fee'] = '扣除后实际到账会少于实际转出。';
$_LANG['cfg_name']['xm_transfer_cash_close'] = '是否关闭新美转账';
$_LANG['cfg_range']['xm_transfer_cash_close']['1'] = '是';
$_LANG['cfg_range']['xm_transfer_cash_close']['0'] = '否';
$_LANG['cfg_name']['xm_transfer_cash_close_reason'] = '关闭理由';

$_LANG['cfg_name']['xm_take_cash_fee'] = '提现手续费(%)';
$_LANG['cfg_name']['xm_take_cash_chuliru'] = '提现处理日';
$_LANG['cfg_name']['xm_take_cash_min_amount'] = '最小提现金额';
$_LANG['cfg_name']['xm_take_cash_max_amount'] = '最大提现金额';
$_LANG['cfg_name']['xm_closing_weekend_withdrawals'] = '是否关闭周末提现';
$_LANG['cfg_range']['xm_closing_weekend_withdrawals']['1'] = '是';
$_LANG['cfg_range']['xm_closing_weekend_withdrawals']['0'] = '否';
$_LANG['cfg_name']['xm_daily_cash_ceiling'] = '每人每日提现上限';
$_LANG['cfg_name']['xm_closing_withdrawals'] = '是否关闭提现';
$_LANG['cfg_range']['xm_closing_withdrawals']['1'] = '是';
$_LANG['cfg_range']['xm_closing_withdrawals']['0'] = '否';
$_LANG['cfg_name']['xm_closing_cash_reason'] = '关闭理由';

$_LANG['back_xinmei_settings'] = '返回新美设置';
$_LANG['xinmei_save_success'] = '新美设置修改成功。';

$_LANG['cfg_name']['xm_bind_card'] = '银行卡绑定';
$_LANG['cfg_name']['xm_bind_card_pause'] = '是否暂停绑定银行卡';
$_LANG['cfg_range']['xm_bind_card_pause']['1'] = '是';
$_LANG['cfg_range']['xm_bind_card_pause']['0'] = '否';
$_LANG['cfg_name']['xm_bind_card_pause_reason'] = '暂停理由';
$_LANG['cfg_name']['xm_cash_large_transfer'] = '是否开启新美积分大金额转账验证';
$_LANG['cfg_range']['xm_cash_large_transfer']['1'] = '是';
$_LANG['cfg_range']['xm_cash_large_transfer']['0'] = '否';
$_LANG['cfg_name']['xm_cash_large_amount_value'] = '新美积分转账大金额值';
$_LANG['cfg_name']['xm_consume_large_transfer'] = '是否开启消费积分大金额转账验证';
$_LANG['cfg_range']['xm_consume_large_transfer']['1'] = '是';
$_LANG['cfg_range']['xm_consume_large_transfer']['0'] = '否';
$_LANG['cfg_name']['xm_consume_large_amount_value'] = '消费积分转账大金额值';
$_LANG['cfg_name']['xm_wechat_business_recharge']='服务中心充值';
$_LANG['cfg_name']['xm_h_set']='H单设置';
$_LANG['cfg_name']['xm_h_begin']='H单开始时间';
$_LANG['cfg_name']['xm_h_end']='H单结束时间';
$_LANG['cfg_name']['xm_3w_wechat_business_team']='3w服务中心充值团队人数限制';
$_LANG['cfg_name']['xm_10w_wechat_business_team']='10w服务中心充值团队人数限制';
$_LANG['cfg_name']['xm_30w_wechat_business_team']='30w服务中心充值团队人数限制';
$_LANG['cfg_name']['xm_3w_wechat_business_audit']='3w服务中心充值是否审核';
$_LANG['cfg_range']['xm_3w_wechat_business_audit']['1']='是';
$_LANG['cfg_range']['xm_3w_wechat_business_audit']['0']='否';
$_LANG['cfg_name']['xm_10w_wechat_business_audit']='10w服务中心充值是否审核';
$_LANG['cfg_range']['xm_10w_wechat_business_audit']['0']='否';
$_LANG['cfg_range']['xm_10w_wechat_business_audit']['1']='是';
$_LANG['cfg_name']['xm_30w_wechat_business_audit']='30w服务中心充值是否审核';
$_LANG['cfg_range']['xm_30w_wechat_business_audit']['0']='否';
$_LANG['cfg_range']['xm_30w_wechat_business_audit']['1']='是';
