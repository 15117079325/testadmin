...
$_LANG['template_files']['barter_big_list'] = '易业商城列表';
$_LANG['template_files']['barter_mid_list'] = '精品商城商城列表';
$_LANG['template_files']['barter_h_list'] = 'H单商城列表';
...
$_LANG['template_libs']['barter_big_hot'] = '易业商城热卖商品';
$_LANG['template_libs']['barter_big_list'] = '易业商城列表商品';
$_LANG['template_libs']['barter_mid_hot'] = '精品商城热卖商品';
$_LANG['template_libs']['barter_mid_list'] = '精品商城列表商品';
$_LANG['template_libs']['barter_goods'] = '楼层内某种易物的商品（注：‘简称’为楼层左侧快捷定位侧边栏内显示当前楼层的简称，为了页面美观性，建议填写两个汉字；‘颜色’设置的是当前楼层主题颜色）';
