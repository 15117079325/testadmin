...
$_LANG['surplus_not_enough'] = '您使用的优惠券不能超过您现有的优惠券。';
...
$_LANG['cash_credit'] = '￥<span> %s</span>';
$_LANG['consume_credit'] = '消费积分：<span> %s</span>';
$_LANG['subtotal_amount_desc'] = '应付总额： <span>￥ %s + 消费积分： %s</span>';
...
$_LANG['flow_js']['invalid_cash'] = '您输入的新美积分不是一个合法的新美积分。';
...
$_LANG['balance_not_enough'] = '您的优惠券不足以支付整个订单，请选择其他支付方式';
