...
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的金额超过了您现有的优惠券，此操作将不可进行！';
...
$_LANG['pay_order_by_surplus'] = '追加使用优惠券支付订单：%s';
...
/* 取回密码 */
$_LANG['label_input_uname'] = '请输入您的用户名/已验证的手机';
...
$_LANG['login_failure_forbide'] = '此帐号被禁用，请联系管理员';
...
$_LANG['agreement'] = "我已阅读并接受《<a href=\"article.php?cat_id=-1\" style=\"color:blue\" target=\"_blank\">用户协议</a>》";
...
$_LANG['passport_js']['msg_invite_code_blank'] = '请填写邀请码';
$_LANG['passport_js']['invite_code_error'] = '邀请码不正确，请联系邀请人';
...
$_LANG['passport_js']['msg_username_format'] = '- 用户名不合法';
...
$_LANG['exchange_js']['balance'] = '您的{%s}优惠券不足，请重新输入';
...
/* 2017-02-08 代码添加 By wj Start */
$_LANG['business_pwd_update'] = '修改交易密码';
$_LANG['exchange_shopping_vouchers'] = '消费激活';
//$_LANG['wechat_business_recharge'] = '充值服务中心';
$_LANG['wechat_business_recharge'] = '服务中心';
$_LANG['back_list'] = '退货';

$_LANG['zhanghu_yue'] = '账户优惠券';
$_LANG['jifen_duihuan'] = '积分兑换';
$_LANG['jifen_huzhuang'] = '积分复投';
$_LANG['jifen_zhuanzhang'] = '消费积分转账';
$_LANG['jifen_ingxi'] = '积分明细';
//$_LANG['my_invitation_code'] = '我的邀请码';
$_LANG['my_member'] = '我的会员';
$_LANG['no_buy_back_list'] = '直推没回购列表';
$_LANG['goods_recommend_commission'] = '商品推荐提成';
$_LANG['label_invite_code'] = '邀请码';
$_LANG['announce_list'] = '公告列表';
/* 2017-02-08 代码添加 By  wj End */

/* 2017-02-14 代码添加 By wj Start */
$_LANG['passport_js']['msg_invite_code_blank'] = '- 邀请的手机号码不能为空';
$_LANG['passport_js']['msg_invite_code_getshi_not_valid'] = '- 邀请的手机号格式不正确';
$_LANG['passport_js']['msg_invite_code_not_valid'] = '- 邀请码无效';
$_LANG['passport_js']['msg_invite_code_valid'] = '- 邀请码有效';
/* 2017-02-08 代码添加 By  wj End */
/*add  用户名 by fzp*/
$_LANG['passport_js']['msg_username_blank'] = '- 用户名不能为空';
$_LANG['passport_js']['msg_username_not_valid'] = '- 用户名已经存在';
$_LANG['passport_js']['msg_username_valid'] = '- 用户名可以注册';
/*add  用户名 end*/

/*add  验证码 by fzp*/
$_LANG['passport_js']['msg_captcha_blank'] = '- 验证码不能为空';
$_LANG['passport_js']['msg_captcha_not_valid'] = '- 验证码无效';
$_LANG['passport_js']['msg_captcha_valid'] = '- 验证码正确';
/*add  验证码 end*/
// add by fuhuauqan 2018/1/17
$_LANG['captcha_error'] = '您输入的验证码不正确。';
$_LANG['login_faild'] = '您输入的帐号信息不正确。';
$_LANG['login_failure'] = '用户名或密码不正确。';
